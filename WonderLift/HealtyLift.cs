...
{
    public class HealtyLift : Lift
    {
        public HealtyLift(Type typeOfLift, int maximumFloor, int minimumFloor, string name, int numberOfFloors, int speed) : base(typeOfLift, maximumFloor, minimumFloor, name, numberOfFloors, speed)
        {
        }
